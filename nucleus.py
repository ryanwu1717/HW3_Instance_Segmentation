...
class NucleusDataset(utils.Dataset):
    ...
    def load_nucleus(self, dataset_dir, subset):
        ...
        assert subset in ["train", "val", "stage1_train", "stage1_test", "stage2_test","test"]
        ...
        if subset == "val":
            ...
            for testimage in data:
                ...
                image_ids.append(testimage['file_name'])
        else:
...
def mask_to_rle(image_id, mask, scores):
    ...
    # if len(mask.shape) == 3:
    #     return _mask.encode(mask)
    # elif len(mask.shape) == 2:
    #     h, w = mask.shape
    #     return _mask.encode(mask.reshape((h, w, 1), order='F'))[0]
    print( mask.ndim)
    print(mask.shape[-1])
    ...
    for o in order:
        ...
        # elif len(m.ndim) == 2:
        #     h, w = m.shape
        #     rle =  _mask.encode(m.reshape((h, w, 1), order='F'))[0] 
        # print("1")
        if m.sum() == 0.0:
            # print('0')
            continue
    ...
    def build_coco_results(dataset, image_ids, rois, class_ids, scores, masks):
        ...
        for image_id in image_ids:
            ...
            for i in range(rois.shape[0]):
                ...
                result = {
                    "image_id": image_id,
                    "category_id":dataset.get_source_class_id(class_id, "nuclei"),
